		...
		<!--Header Wrapper ends-->
			...
			<div class="content">
				...
				<div id="test">
					...
					<br>
					<textarea cols="40" rows="1" name="title" placeholder="Write a Title..." size="45" required="required" background color:"gray"/></textarea><br/> 
					<textarea cols="60" rows="4" name="content" placeholder="Write description..."></textarea><br/>
					<br>
					<select name="topic">
					...
					<br><br>
						...
						<h3><font color="darkslategray">All Posts in this Category!</font></h3> 
						<?php get_Cats();?>
