	...
	<div class="container">
		...
		<!--Header Wrapper ends-->
			...
			<div class="content">
				...
				<div id="test">
					<h2><font color="darkslategray">Edit Your Post</font></h2>
					<br>
					<textarea cols="40" rows="1" name="title"  size="45" required="required" background color:"gray"/><?php echo $post_title; ?></textarea><br/> 
					<textarea cols="60" rows="4" name="content" ><?php echo $post_content; ?></textarea><br/>
					<br>
					<select name="topic">
